...
| **Associative containers** | `std::map` | Store elements as key-value pairs and provide efficient retrieval based on keys. The main types of associative containers are std::map, std::multimap, std::set, and std::multiset. |
